...
import           Cardano.PlutusExample.HelloWorld4b (helloMessage, helloWorldSBS, helloWorldSerialised)
...
main = do
  ...
  writePlutusScript helloMessage scriptname helloWorldSerialised helloWorldSBS
